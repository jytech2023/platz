    ...
    <main className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-5xl mx-auto">
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <Link href="/dashboard/tickets" className="text-xs font-medium text-accent hover:text-[#005baa] transition-colors">
        ...
        {recentTickets.length === 0 ? (
          <div className="px-5 py-12 text-center">
            ...
            <Link href="/dashboard/tickets/new" className="inline-flex items-center gap-1.5 text-sm font-medium text-accent hover:text-[#005baa]">
